...
public class CampusCreateValidator : ValidationBase<CampusCreateDto>
{
    ...
    public CampusCreateValidator(IAbpLazyServiceProvider lazyServiceProvider) : base(lazyServiceProvider)
    {
        ...
        RuleFor(x => x.ShortName)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConstants.ShortName, 1, CampusConstants.MaxShortNameLength));
        ...
        RuleFor(x => x.RoomNumber)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConstants.RoomNumber, 1, CampusConstants.MaxRoomNumberLength));
        ...
        RuleFor(x => x.HeadOfCampus)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConstants.HeadOfCampus, 1, CampusConstants.MaxHeadOfCampusLength));
        ...
        RuleFor(x => x.HeadOfCampusPhone)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConstants.HeadOfCampusPhone, 1, CampusConstants.MaxHeadOfCampusPhoneLength));
        ...
        RuleFor(x => x.HeadOfCampusEmail)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConstants.HeadOfCampusEmail, 1, CampusConstants.MaxHeadOfCampusEmailLength));
        ...
        RuleFor(x => x.ServicesOffered)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConstants.ServicesOffered, 1, CampusConstants.MaxServicesOfferedLength));

        // 验证紧急联系人
        RuleFor(x => x.EmergencyContact)
            .Length(1, CampusConstants.MaxEmergencyContactLength)
            .When(x => !string.IsNullOrEmpty(x.EmergencyContact))
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConstants.EmergencyContact, 1, CampusConstants.MaxEmergencyContactLength));

        // 验证紧急联系电话
        RuleFor(x => x.EmergencyPhone)
            .Length(1, CampusConstants.MaxEmergencyPhoneLength)
            .When(x => !string.IsNullOrEmpty(x.EmergencyPhone))
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConstants.EmergencyPhone, 1, CampusConstants.MaxEmergencyPhoneLength));
    }
}