    ...
    public CampusUpdateValidator(IAbpLazyServiceProvider lazyServiceProvider) : base(lazyServiceProvider)
    {
        ...
        RuleFor(x => x.ShortName)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConsts.ShortName, 1,
                CampusConsts.MaxShortNameLength));
        ...
        RuleFor(x => x.RoomNumber)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConsts.RoomNumber, 1,
                CampusConsts.MaxRoomNumberLength));
        ...
        RuleFor(x => x.HeadOfCampus)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConsts.HeadOfCampus, 1,
                CampusConsts.MaxHeadOfCampusLength));
        ...
        RuleFor(x => x.HeadOfCampusPhone)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConsts.HeadOfCampusPhone, 1,
                CampusConsts.MaxHeadOfCampusPhoneLength));
        ...
        RuleFor(x => x.HeadOfCampusEmail)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConsts.HeadOfCampusEmail, 1,
                CampusConsts.MaxHeadOfCampusEmailLength));
        ...
        RuleFor(x => x.ServicesOffered)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConsts.ServicesOffered, 1,
                CampusConsts.MaxServicesOfferedLength));
        ...
        RuleFor(x => x.EmergencyContact)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConsts.EmergencyContact, 1,
                CampusConsts.MaxEmergencyContactLength));
        ...
        RuleFor(x => x.EmergencyPhone)
            ...
            .WithMessage(FieldLengthFormatLocalized(LocalizedTextsConsts.EmergencyPhone, 1,
                CampusConsts.MaxEmergencyPhoneLength));
    }
}