...
public class PermissionTree : PermissionBase
{
    ...
    public PermissionTree(string permissionName,
        ...
        bool? canTo = false) : base(permissionName, displayName, path, component, parentName, type, name, redirect, alias, hidden, alwaysShow, title, icon, noCache, breadcrumb, affix, activeMenu, noTagsView, canTo)
    {
    }
