...
namespace Heal.Net.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20260204064245_Update1010Rc2Doc")]
    partial class Update1010Rc2Doc
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Volo.Abp.AuditLogging.AuditLogExcelFile", b =>
                {
                    ...
                    b.ToTable("AbpAuditLogExcelFiles", null, t =>
                        {
                            t.HasComment("审计日志-文件");
                        });
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUserPasskey", b =>
                {
                    ...
                    b.ToTable("AbpUserPasskeys", null, t =>
                        {
                            t.HasComment("用户密码");
                        });
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUserPasswordHistory", b =>
                {
                    ...
                    b.ToTable("AbpUserPasswordHistories", null, t =>
                        {
                            t.HasComment("用户密码历史记录");
                        });
                });
            ...
            modelBuilder.Entity("Volo.Abp.PermissionManagement.ResourcePermissionGrant", b =>
                {
                    ...
                    b.ToTable("AbpResourcePermissionGrants", null, t =>
                        {
                            t.HasComment("资源权限管理");
                        });
                });
